module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // 2. Crear Tabla activity_assignees (muchos a muchos)
    await queryInterface.createTable('activity_assignees', {
      id: {
        type: Sequelize.UUID,
        defaultValue: Sequelize.UUIDV4,
        primaryKey: true,
    ...
    // 3. Crear Tabla activity_comments
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.dropTable('activity_assignees');
