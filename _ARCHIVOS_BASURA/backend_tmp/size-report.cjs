...
// Also print a short recommended list
const candidates = rows.filter(r=> r.isDir && (r.name === 'node_modules' || r.name === 'frontend' || r.name === 'backend' || r.name === 'public' || r.name === 'unnecessary_files' || r.name === 'dist'));
